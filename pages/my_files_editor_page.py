...
class MyFilesEditorPage(BasePage):
    ...
    def is_element_allowed(self, section: str, access_level: str, title: str, class_attr: str, file_type: str = None) -> bool:
        ...
        ACCESS_MATRIX = {
            ...
            "Рецензирование": {
                "Просмотр": ["Решить", "Удалить", "Отображение", "Предыдущее изменение", "Следующее изменение", "Принять","Отклонить" ,"Сравнить","История версий"],
                "Комментирование": ["Добавить комментарий", "Решить", "Удалить", "Отображение", "Предыдущее изменение", "Следующее изменение","Принять", "Отклонить", "Сравнить", "История версий"],
                "Рецензирование": ["Добавить комментарий", "Решить", "Удалить", "Отображение", "Предыдущее изменение", "Следующее изменение", "Принять", "Отклонить", "Сравнить", "История версий", "Запись изменений (active)"],
                "Полный доступ": ["ALL"]
            },
            "Конструктор": {
                "Просмотр": ["Все ответы"],
