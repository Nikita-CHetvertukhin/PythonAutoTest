class WorkflowsLocators:
    ...
    # Столбцы body
    WORKFLOWS_COLUMNS = '//div[contains(@class,"finder") and not(contains(@class,"none"))]//div[contains(@class, "tab") and not(contains(@class,"inactive"))]//div[@class="scroller headers"]/table/tbody/tr[@class="header"]'

    # Кнопка "Создать процесс"
    WORKFLOWS_CREATE = '//div[@class="body"]//div[contains(@class,"finder") and not(contains(@class,"none"))]/div[@class="body"]/div[contains(@class,"workspace")and not(contains(@class,"inactive"))]/div/div/a[contains(@class,"create")]/span'
